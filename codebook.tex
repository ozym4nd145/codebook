...
\usepackage{amsmath}
\usepackage{multicol}
\usepackage[landscape,letterpaper,twoside=false,top=10mm,bottom=15mm,left=10mm,right=10mm]{geometry}
...
\subsection{LCA} %Suyash
\lstinputlisting[language=c++]{lca.cpp}

\subsection{Segment Tree (Lazy)} %Suyash
\lstinputlisting[language=c++]{segtree.cpp}
...
\subsection{Z Algorithm} % Stanford
\lstinputlisting[language=c++]{Z.cpp}

\subsection{Longest palindromic substring (Manacher\'s)} % Brian Bi
...
\subsection{Counting Inversion} %Suyash
\lstinputlisting[language=c++]{inversion.cpp}

\subsection{Template} % Suyash
\lstinputlisting[language=c++]{template.cpp}

\subsection{Primes} % Suyash
\lstinputlisting[language=c++]{primes.cpp}
